...
function Contact() {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-[#221b42] flex justify-center items-center p-4"
    >
      <form
        method="POST"
        action="https://getform.io/f/6326195d-a96e-44ff-bf5a-672c77d988b3"
